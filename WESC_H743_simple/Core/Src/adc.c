...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC1_INP9
    */
    GPIO_InitStruct.Pin = TEMP_MOS_Pin|I_Phase_W_Pin;
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PC5     ------> ADC2_INP8
    */
    GPIO_InitStruct.Pin = I_Phase_V_Pin|U_Phase_U_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GPIO_PIN_4|U_Phase_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    GPIO_InitStruct.Pin = I_Phase_U_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(I_Phase_U_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_INP9
    */
    HAL_GPIO_DeInit(GPIOA, TEMP_MOS_Pin|I_Phase_W_Pin);

    HAL_GPIO_DeInit(U_Phase_W_GPIO_Port, U_Phase_W_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_INP8
    */
    HAL_GPIO_DeInit(GPIOA, I_Phase_V_Pin|U_Phase_U_Pin);

    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_4|U_Phase_V_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(I_Phase_U_GPIO_Port, I_Phase_U_Pin);
